...
export const mockVirtualWarehouses: Partial<Warehouse>[] = [
  {
    name: "Almacén para proveedor - En Tránsito",
    type: "virtual",
    status: "active",
    locationId: 1,
    description:
      "Almacén para proveedor para gestionar inventario en tránsito entre ubicaciones",
    virtualSubType: "in_transit",
    virtualRules: defaultVirtualRulesBySubType["in_transit"],
    linkedPhysicalWarehouseId: 1,
  },
  {
    name: "Almacén para Proveedor - Inspección Calidad",
    type: "virtual",
    status: "active",
    locationId: 1,
    description:
      "Almacén virtual para gestionar productos en inspección de calidad",
    virtualSubType: "inspection",
    virtualRules: defaultVirtualRulesBySubType["inspection"],
    linkedPhysicalWarehouseId: 1,
  },
  {
    name: "Almacén para Proveedor - Reparaciones",
    type: "virtual",
    status: "active",
    locationId: 2,
    description:
      "Almacén para proveedor para gestionar productos en proceso de reparación",
    virtualSubType: "repair",
    virtualRules: defaultVirtualRulesBySubType["repair"],
    linkedPhysicalWarehouseId: 2,
  },
  {
    name: "Almacén para Proveedor - Mercancía Dañada",
    type: "virtual",
    status: "active",
    locationId: 1,
    description:
      "Almacén para proveedor para gestionar productos dañados o defectuosos",
    virtualSubType: "damaged_goods",
    virtualRules: defaultVirtualRulesBySubType["damaged_goods"],
    linkedPhysicalWarehouseId: 1,
  },
  {
    name: "Almacén para Proveedor - Devoluciones",
    type: "virtual",
    status: "active",
    locationId: 3,
