...
export default function Header() {
  ...
  const sidebarVisible = useSelector((state: any) => state.themeConfig.sidebar);
    ...
    >
      <div className="shadow-sm border-b border-gray-200/60 dark:border-white/10">
        <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
          <div
            className={`flex items-center gap-4 ${!sidebarVisible ? "lg:hidden" : "lg:flex"}`}
          >
            <div className="flex gap-4 items-center justify-between ltr:mr-2 rtl:ml-2">
              <button
                type="button"
