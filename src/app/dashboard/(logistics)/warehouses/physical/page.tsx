...
async function WarehousesPhysicalPage({ searchParams }: PageProps) {
  const params = await searchParams;
  // Aseguramos que el tipo sea "physical" para esta página
  const queryParams = { ...params, type: "physical" };
