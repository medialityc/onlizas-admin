...
export const metadata: Metadata = {
  title: "Gestión de Productos - ZAS Express",
  description:
    "Administra los productos del sistema con sus categorías y unidades",
  icons: {
...
async function ProductsListPage({ searchParams }: PageProps) {
