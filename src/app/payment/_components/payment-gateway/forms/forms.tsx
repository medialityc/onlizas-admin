...
import { GatewayFormProps, Field, TypeGateway } from "@/app/payment/interfaces";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { gatewaysConfig } from "./forms-config";
...
export default function PaymentGateways({
  ...
  name: TypeGateway["type"];
}) {
  return (
    <div className="space-y-10">
      <div className="transition-all duration-500 ease-in-out">
        <GatewayForm {...gatewaysConfig[name]} />
      </div>
    </div>
  );
}
