...
export const currencySchema = z.object({
  ...
  codIso: z
    .string({ error: "El código ISO es obligatorio." })
  ...
  regionIds: z.array(z.union([z.number(), z.string()])),
});
