...
import { RegionLogs, GetAllRegionLogs } from "@/types/regions";
...
function RegionsLogsContent({
  ...
  const grouped = useMemo(() => {
    const groups: Record<string, RegionLogs[]> = {};
  ...
  const columns: DataTableColumn<RegionLogs>[] = [
    {
      accessor: "timestamp",
      title: "Fecha/Hora",
      sortable: true,
    ...
    { accessor: "regionCode", title: "Código", sortable: true },
    { accessor: "regionName", title: "Región", sortable: true },
    { accessor: "action", title: "Acción", sortable: true },
    { accessor: "entityType", title: "Tipo", sortable: true },
      ...
      {grouped.length > 0 ? (
        <div className="space-y-8">
          ...
          <SimpleModal
            ...
            className="max-w-3xl"
          >
            {selected && <RegionLogDetail log={selected} />}
          </SimpleModal>
        </div>
      ) : (
...
export default RegionsLogsContent;
