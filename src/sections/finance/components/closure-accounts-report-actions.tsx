  ...
  const handleExportPdf = () => {
    ...
    if (statement) {
      ...
      autoTable(doc, {
        ...
        head: [["Métrica", "Valor"]],
        body: [
          ["Ingresos", formatCurrency(statement.totalIncome, "USD")],
          ["Tarifa plataforma", formatCurrency(statement.platformFee, "USD")],
          ["Impuestos", formatCurrency(statement.taxes, "USD")],
          ["Proveedores", formatCurrency(statement.suppliersTotal, "USD")],
          ["Logística", formatCurrency(statement.logisticsTotal, "USD")],
          ["Total cuentas", String(totalAccounts)],
          ["Total a pagar", formatCurrency(totalAmount, "USD")],
        ],
        styles: { fontSize: 8 },
    ...
    if (statement?.supplierBalances?.length) {
      ...
      autoTable(doc, {
        ...
        body: statement.supplierBalances.map((b) => [
          b.supplierName,
          formatCurrency(b.productAmount, "USD"),
          formatCurrency(b.deliveryAmount, "USD"),
    ...
    if (accounts && accounts.length) {
      ...
      autoTable(doc, {
        ...
        body: accounts.map((a) => [
          ...
          formatCurrency(a.totalAmount, "USD"),
