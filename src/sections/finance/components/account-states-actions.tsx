  ...
  const handleExportPdf = () => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ["Ingresos totales", formatCurrency(summary.totalIncome, "USD")],
        ["Onlizas", formatCurrency(summary.platformFee, "USD")],
        ["Impuestos", formatCurrency(summary.taxes, "USD")],
        ["Proveedores", formatCurrency(summary.suppliersTotal, "USD")],
        ["Logística", formatCurrency(summary.logisticsTotal, "USD")],
    ...
    if (summary.latestClosure) {
      ...
      autoTable(doc, {
        ...
        body: [
          ...
          ["Ingresos", formatCurrency(latest.totalIncome, "USD")],
    ...
    if (suppliers && suppliers.length) {
      ...
      autoTable(doc, {
        ...
        body: suppliers.map((s) => [
          s.supplierName,
          s.email,
          formatCurrency(s.productAmount, "USD"),
          formatCurrency(s.deliveryAmount, "USD"),
          formatCurrency(s.platformFeeAmount, "USD"),
          formatCurrency(s.taxAmount, "USD"),
          formatCurrency(s.supplierAmount, "USD"),
