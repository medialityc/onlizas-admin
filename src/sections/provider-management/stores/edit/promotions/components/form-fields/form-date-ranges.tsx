 ...
 */
export default function FormDateRanges({
  name = "dateRanges",
}: {
  name?: string;
}) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-1">
        <label className="mb-0 text-sm font-semibold text-gray-900  dark:text-gray-100">
          Rangos de fechas
        </label>
        <Button
          type="button"
      ...
      <div className="space-y-4">
        {fields.length === 0 && (
          <div className="text-sm text-gray-500">
            No hay rangos de fechas seleccionados
          </div>
        )}
        ...
        {fields.map((field, idx) => (
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-sm  dark:text-gray-100 font-medium text-gray-700">
                Rango {idx + 1}
              </span>
              <Button
                type="button"
