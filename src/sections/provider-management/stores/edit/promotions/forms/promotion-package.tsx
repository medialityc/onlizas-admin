...
import { FormInput, FormDate, FormDateRanges, ValueSelector } from "../components/form-fields";
    ...
    return (
        <FormProvider {...methods}>
            <form onSubmit={onFormSubmit} className="space-y-6">
                <PromotionTypeHeader title="Descuento por paquetes" description="Establecer valores para descuento por paquete" icon={<span>📦</span>} />
                <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                    <CardContent>
                        <PromotionBasicInfo showCode={false} typeLabel="Descuento por paquete" />
                        <div className="mt-4">
                ...
                <Card className="gap-2 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                    ...
                    <CardContent className="space-y-2">
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            <ProductSelect multiple={true} name="productVariantsIds" storeId={storeId} label="Productos aplicables" />
                        </div>
                    </CardContent>
                </Card>
