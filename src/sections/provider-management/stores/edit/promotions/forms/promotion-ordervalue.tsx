...
import {
  orderValueSchema,
  type OrderValueFormData,
} from "../schemas/order-value-schema";
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={onFormSubmit} className="space-y-6">
        <PromotionTypeHeader
          title="Descuento por valor del pedido"
          description="Establecer condiciones de descuento basado en el valor del pedido"
          icon={<span>🛒</span>}
        />
        <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <CardContent>
            <PromotionBasicInfo
              showCode={false}
              typeLabel="Descuento por pedido"
            />
            <div className="mt-4">
              <RHFImageUpload
                name="mediaFile"
