...
import { FormInput, FormDate, FormDateRanges, ValueSelector, ProductMultiSelect } from "../components/form-fields";
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={onFormSubmit} className="space-y-6">
        <PromotionTypeHeader title="Descuento por producto" description="Establecer valores para descuento para un producto Y comprando un prodcuto X" icon={<span>  🎁        </span>} />
        <Card>
          <CardContent>
            <PromotionBasicInfo showCode={false} typeLabel="Descuento por producto" />
            <div className="mt-4">
          ...
          <CardContent className="space-y-2">
            <div className="grid grid-cols-1 gap-3">
              <div className="pt-0">
                ...
                <ValueSelector showPercent={true} showAmount={true} showFree={true} typeName="discountType" valueName="discountValue" />
              </div>
              <ProductSelect name="productIdX" storeId={storeId} label="Producto X" multiple={false} />
              <ProductSelect name="productIdY" storeId={storeId} label="Producto Y" multiple={false} />
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <RHFInputWithLabel name="minimumAmount" label="Cantidad mínima de producto X (C$)" type="number" />
            </div>
          </CardContent>
        </Card>
