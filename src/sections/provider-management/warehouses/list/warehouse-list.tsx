    ...
    <>
      <div className="space-y-6 px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-none">
            <CardContent className="p-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm p-1 text-gray-600 dark:text-gray-400">Total Almacenes</p>
          ...
          <Card className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-none">
            <CardContent className="p-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm p-1 text-gray-600 dark:text-gray-400">Capacidad Total</p>
          ...
          <Card className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-none">
            <CardContent className="p-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm p-1 text-gray-600 dark:text-gray-400">Espacio Ocupado</p>
          ...
          <Card className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-none">
            <CardContent className="p-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm p-1 text-gray-600 dark:text-gray-400">Utilizado</p>
