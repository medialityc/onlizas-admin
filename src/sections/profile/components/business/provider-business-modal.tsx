...
import { useProviderBusinessMutation } from "@/sections/profile/hooks/use-provider-business-mutation";
...
export default function ProviderBusinessModal({
  ...
  const permis = hasPermission([PERMISSION_ENUM.UPDATE_BUSINESS]);
