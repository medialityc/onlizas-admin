import { z } from 'zod';
import { VirtualWarehouseSubType } from '@/types/warehouses';

// Esquema para reglas de almacenes virtuales
const virtualWarehouseRulesSchema = z.object({
...
export const warehouseFormSchema = z.object({
  ...
  managerEmail: z.string().email('Email inválido').optional().or(z.literal('')),
  ...
  message: "Los campos requeridos según el tipo de almacén deben estar completos",
  path: ["type"]
});
