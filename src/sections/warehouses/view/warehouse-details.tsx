...
import { BuildingStorefrontIcon, BuildingOfficeIcon, MapPinIcon, UserIcon } from '@heroicons/react/24/outline';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600 dark:text-gray-300">{w.type === 'physical' ? 'Físico' : 'Virtual'}</span>
          </div>
          {w.type === 'physical' && (
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="font-semibold text-gray-700 dark:text-gray-200">Capacidad:</span>
                <span className="text-gray-600 dark:text-gray-300">{w.currentCapacity || 0} / {w.maxCapacity || 0}</span>
