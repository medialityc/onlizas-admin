...
export default function WarehouseReceptionProcessContainer({
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      case "products":
        return (
          <ReceptionProductsTab reception={reception} warehouse={warehouse} />
        );
      case "discrepancies":
        return (
          <ReceptionDiscrepanciesTab
            reception={reception}
            warehouse={warehouse}
          />
        );
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Gestiona la recepción de mercancía y registra cualquier
              discrepancia
            </p>
          </div>
