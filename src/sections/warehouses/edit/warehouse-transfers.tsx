  ...
  const onSubmit = handleSubmit((data) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold text-gray-900">Transferencias de Inventario</h2>
        <Button
          variant="primary"
      ...
      <FormProvider {...methods}>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Almacén Destino</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Seleccionar Inventarios para Transferir</h3>
            ...
            {mockTransferData.map((item) => (
              <div key={item.id} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  <h5 className="text-sm font-medium text-gray-700">Cantidades por variante:</h5>
