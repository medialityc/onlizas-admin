...
function EditHeader({ warehouse }: { warehouse: WarehouseFormData }) {
  ...
  const IconComponent =
    warehouse.type === "physical" ? BuildingStorefrontIcon : BuildingOfficeIcon;
  const iconBgColor =
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div className="flex items-start space-x-4">
          <div className="flex-shrink-0">
            <div
              className={`w-16 h-16 ${iconBgColor} rounded-2xl flex items-center justify-center shadow-lg`}
            >
